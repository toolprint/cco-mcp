...
function AppFinal() {
  ...
  const hasActiveFilters = selectedState !== 'ALL' || selectedAgent !== 'ALL' || searchQuery !== '';
        ...
        <div className="mb-6 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <Button
              ...
              variant={showFilters || hasActiveFilters ? "blueprint" : "blueprint-outline"}
              size="sm"
              className="gap-2"
            >
              ...
              {hasActiveFilters && (
                <Badge variant="blueprint" className="ml-1 px-1 py-0 text-xs">
                  {[selectedState !== 'ALL', selectedAgent !== 'ALL', searchQuery !== ''].filter(Boolean).length}
                </Badge>
              )}
            </Button>
          </div>
            ...
            {error ? (
              <div className="rounded-lg bg-destructive/10 p-4 text-center">
                <p className="text-sm text-destructive">
                  Error loading audit logs: {error ? String(error) : 'Unknown error'}
                </p>
              </div>
